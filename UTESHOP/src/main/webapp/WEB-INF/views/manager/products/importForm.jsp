...
<div class="container-fluid px-4">
    <h1 class="mt-4 mb-4 fw-bold text-primary">
        <i class="fas fa-plus-circle me-2"></i>Nhập hàng sản phẩm
    </h1>
    ...
    <div class="card form-card">
        <div class="card-body">
            <form method="POST" action="${pageContext.request.contextPath}/api/manager/products/import">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <small class="text-muted">Số lượng > 0</small>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-12">
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-save me-2"></i>Lưu nhập hàng
                        </button>
