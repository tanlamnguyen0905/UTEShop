                        ...
                        <div class="accordion-item">
                            <h6 class="accordion-header" id="headingFit">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseFit" aria-expanded="false" aria-controls="collapseFit">
                                    Phù hợp với
                                </button>
                            </h6>
                            <div id="collapseFit" class="accordion-collapse collapse show" aria-labelledby="headingFit"
                                data-bs-parent="#filterAccordion">
                                <div class="accordion-body">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="fit" id="fit1">
                                        <label class="form-check-label" for="fit1">Mặc hàng ngày</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="fit" id="fit2">
                                        <label class="form-check-label" for="fit2">Mặc ở nhà</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="fit" id="fit3">
                                        <label class="form-check-label" for="fit3">Thể thao</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-4">
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card border-0 shadow-sm h-100 rounded-4">
                            <img src="sp1.jpg" class="card-img-top rounded-4" alt="Áo thun nam 1">
                            <div class="card-body text-center">
                                <span class="badge bg-dark mb-2">Đáng mua</span>
                                <h6 class="fw-semibold mb-1">Áo thun thể thao</h6>
                                <p class="text-danger fw-bold mb-0">199.000đ</p>
                            </div>
                        </div>
                    </div>
